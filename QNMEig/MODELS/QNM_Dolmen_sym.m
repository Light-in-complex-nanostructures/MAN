function out = model
%
% dolmen_PRA2020_multipole_sym.m
%
% Model exported on Jan 15 2020, 10:30 by COMSOL 5.4.0.225.
...
model.label('QNM_Dolmen-sym.mph');
...
model.param.set('width_gros', '128[nm]', 'Geom: Width of top rod');
model.param.set('length_gros', '50[nm]', 'Geom: Length of top rod');
...
model.param.set('sym_factor', '4', 'Symmetry factor=2^(Num of symm planes)');
...
model.component('mod1').geom('geom1').feature('uni1').selection('input').set({'blk1' 'blk2' 'blk3' 'sph1'});
model.component('mod1').geom('geom1').create('blk4', 'Block');
model.component('mod1').geom('geom1').feature('blk4').set('pos', {'0' '-r_pml' '0'});
model.component('mod1').geom('geom1').feature('blk4').set('size', {'r_pml' 'r_pml*2' 'r_pml'});
model.component('mod1').geom('geom1').create('int1', 'Intersection');
model.component('mod1').geom('geom1').feature('int1').selection('input').set({'blk4' 'uni1'});
model.component('mod1').geom('geom1').run;

model.component('mod1').selection.create('sel1', 'Explicit');
model.component('mod1').selection('sel1').set([1 3]);
model.component('mod1').selection.create('sel2', 'Explicit');
model.component('mod1').selection('sel2').set([1 2 3]);
model.component('mod1').selection.create('sel3', 'Explicit');
model.component('mod1').selection('sel3').set([4 5]);
...
model.component('mod1').variable('var3').set('QN', '2*sym_factor*intAll((emw.Ex*emw.Dx+emw.Ey*emw.Dy+emw.Ez*emw.Dz)*pml1.detInvT)+sym_factor*intMetal((emw.Ex*emw.Dx+emw.Ey*emw.Dy+emw.Ez*emw.Dz)*pml1.detInvT)*fdisp', 'QNM normalization');
...
model.component('mod1').cpl('intop2').selection.named('sel3');
...
model.component('mod1').physics('emw').feature('weak1').selection.named('sel3');
model.component('mod1').physics('emw').create('pmc1', 'PerfectMagneticConductor', 2);
model.component('mod1').physics('emw').feature('pmc1').selection.set([2 6 13 16 19]);
...
model.component('mod1').mesh('mesh1').feature('ftet3').selection.set([2]);
...
model.component('mod1').mesh('mesh1').feature('swe1').selection.set([1 3]);
...
model.component('mod1').mesh('mesh1').feature('swe1').label('PML');
